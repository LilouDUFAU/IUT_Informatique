public class Afficheur extends Observateur {
    private SondeMeteo observable;
    private String dateHeure;
    private double temperature;
    private double pression;

    public Afficheur(SondeMeteo observable) {
    ...
    public String toString() {
        return "AFFICHEUR : Date et heure (" + dateHeure + "), Température °C (" + temperature + "), Pression hPa (" + pression + ")";
    }
}
